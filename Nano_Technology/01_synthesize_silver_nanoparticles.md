Here's a detailed set of notes for designing an experiment to synthesize silver nanoparticles using chemical reduction methods and analyzing their size and shape using UV-Vis spectroscopy.
